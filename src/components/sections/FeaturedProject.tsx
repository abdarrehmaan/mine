    ...
    <section id="featured-project" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <TiltCard maxTilt={5} className="w-full">
          <div className="p-8 sm:p-12 rounded-3xl glass-panel border border-cyan-500/20 relative overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
            {/* Top Badge & Category */}
            <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-slate-200 text-xs font-mono font-medium transition-all"
                >
                ...
                {project.liveUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 border border-cyan-500/40 text-cyan-300 text-xs font-mono font-medium transition-all shadow-[0_0_15px_rgba(0,240,255,0.2)]"
                  >
                    <span>Live Demo</span>
            ...
            <div className="mb-8">
              ...
              <p className="text-base sm:text-lg text-cyan-200/80 font-normal leading-relaxed max-w-3xl">
                {project.tagline}
              </p>
            </div>
            ...
            {project.metrics && (
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 pb-10 border-b border-white/10">
                {project.metrics.map((metric, idx) => (
                  <div
                    key={idx}
                    className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 flex flex-col justify-center"
                  >
                    <span className="font-mono text-2xl sm:text-3xl font-extrabold text-cyan-400 mb-1">
                      {metric.value}
                    </span>
